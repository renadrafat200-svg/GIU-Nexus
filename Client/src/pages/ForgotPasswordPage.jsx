    ...
    return (
      <div style={styles.wrapper}>
        ...
        <div className="glass-card fade-in" style={styles.card}>
          ...
          <Link to="/login" style={styles.actionLink}>Back to Login</Link>
        </div>
      </div>
    )
  }
  ...
  return (
    <div style={styles.wrapper}>
      ...
      <div className="glass-card fade-in" style={styles.card}>
        ...
        <p style={styles.bottom}><Link to="/login" style={styles.actionLink}>Back to Login</Link></p>
      </div>
    </div>
  )
}
...
const styles = {
  ...
  sub: { color: '#9999BB', fontSize: '0.9rem', marginBottom: '1.8rem', lineHeight: 1.6 },
  bottom: { marginTop: '1.5rem', color: '#9999BB', fontSize: '0.9rem' },
  actionLink: { color: '#1A1A2E', fontWeight: 700, textDecoration: 'underline', textUnderlineOffset: '3px' },
  bubble1: {
